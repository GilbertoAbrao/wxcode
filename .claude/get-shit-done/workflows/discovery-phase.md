...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /wxcode:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/wxcode:discuss-phase [current-phase])
2. Create phase plan (/wxcode:plan-phase [current-phase])
