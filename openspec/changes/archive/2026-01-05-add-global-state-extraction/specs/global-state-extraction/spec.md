...
Extrair declarações GLOBAL de todos os elementos WinDev, criar representação intermediária stack-agnostic, e gerar código de estado e inicialização para múltiplos stacks target.
