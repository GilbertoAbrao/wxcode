...
## Purpose
Integração com Neo4j para análise avançada de grafos de dependências, permitindo análise de impacto, detecção de padrões e visualização interativa.
...
## Cross-References
- Depende de: `dependency-analysis` (fornece dados do grafo)
- Usado por: Fase de conversão (análise de impacto de mudanças)
