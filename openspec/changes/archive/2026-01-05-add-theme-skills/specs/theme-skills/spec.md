...
Sistema de skills por tema Bootstrap que ensinam a LLM a gerar HTML correto para cada componente. Skills são carregados sob demanda (progressive discovery) baseado nos controles presentes na página.
