...
Extrair blocos `<COMPILE IF Configuration="...">` do código WLanguage, gerar arquivos de configuração por ambiente, e permitir conversão diferenciada por configuration (Site vs API).
