...
## Purpose
Define o algoritmo de matching em 3 fases que associa controles extraídos do PDF de documentação com controles parseados do arquivo .wwh/.wdw. O objetivo é maximizar matches e minimizar controles órfãos (existem no .wwh mas não foram encontrados no PDF), reduzindo de ~15% para ~2% de órfãos.
## Requirements
